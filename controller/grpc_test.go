...
func newTestController(mockService service.IAuthService) *controller.AuthServiceImpl {
	validator := utils.NewValidator()
	return controller.NewAuthServiceImpl(mockService, validator)
}
...
func TestForgotPasswordValidation(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			impl := newTestController(mockService)
			resp, err := impl.ForgotPassword(context.Background(), tc.Request)
...
func TestResetPasswordValidation(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			impl := newTestController(mockService)
			resp, err := impl.ResetPassword(context.Background(), tc.Request)
