...
func TestGetUserValidation(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			resp, err := impl.GetUser(context.Background(), tc.Request)
...
func TestGetUserByEmailValidation(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			impl := newTestController(mockService)
			resp, err := impl.GetUserByEmail(context.Background(), tc.Request)
...
func TestDeleteUserValidation(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			impl := newTestController(mockService)
			resp, err := impl.DeleteUser(context.Background(), tc.Request)
